...
const Tutorials = () =>{
  ...
  const lectureArray = [
    {id:1, lecture: "T 2" , room: 6101 , faculty: "Prof Shivang Rai", hours: "0900Hrs - 0950Hrs"},
    {id:2, lecture: "T 2" , room: 6101 , faculty: "Prof Shivang Rai", hours: "0900Hrs - 0950Hrs"},
    {id:3, lecture: "T 2" , room: 6101 , faculty: "Prof Shivang Rai", hours: "0900Hrs - 0950Hrs"},
    {id:4, lecture: "T 2" , room: 6101 , faculty: "Prof Shivang Rai", hours: "0900Hrs - 0950Hrs"}
  ];
